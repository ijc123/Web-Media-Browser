...
*/        
     ...
     */
    protected static boolean accepts(String acceptHeader, String toAccept) {
     ...
     */
    protected static boolean matches(String matchHeader, String toMatch) {
     ...
     */
    protected static long sublong(String value, int beginIndex, int endIndex) {
